package com.my.company.customgenerator;
...
public class CustomAngularGenerator extends AbstractTypeScriptClientCodegen implements CodegenConfig {
  private final Logger LOGGER = LoggerFactory.getLogger(CustomAngularGenerator.class);
  ...
  protected CustomAngularGenerator.QUERY_PARAM_OBJECT_FORMAT_TYPE queryParamObjectFormat = CustomAngularGenerator.QUERY_PARAM_OBJECT_FORMAT_TYPE.dot;
  protected CustomAngularGenerator.PROVIDED_IN_LEVEL providedIn = CustomAngularGenerator.PROVIDED_IN_LEVEL.root;

  private boolean taggedUnions = false;

  public CustomAngularGenerator() {
    super();
    ...
    this.outputFolder = "generated-code/custom-angular";

    supportsMultipleInheritance = true;

    embeddedTemplateDir = templateDir = "custom-angular";
    ...
    providedInOptions.put(CustomAngularGenerator.PROVIDED_IN_LEVEL.none.toString(), "No providedIn)");
    providedInOptions.put(CustomAngularGenerator.PROVIDED_IN_LEVEL.root.toString(), "The application-level injector in most apps.");
    providedInOptions.put(CustomAngularGenerator.PROVIDED_IN_LEVEL.platform.toString(), "A special singleton platform injector shared by all applications on the page.");
    providedInOptions.put(CustomAngularGenerator.PROVIDED_IN_LEVEL.any.toString(), "Provides a unique instance in each lazy loaded module while all eagerly loaded modules share one instance.");
  ...
  public boolean getQueryParamObjectFormatDot() {
    return CustomAngularGenerator.QUERY_PARAM_OBJECT_FORMAT_TYPE.dot.equals(queryParamObjectFormat);
  }

  public boolean getQueryParamObjectFormatJson() {
    return CustomAngularGenerator.QUERY_PARAM_OBJECT_FORMAT_TYPE.json.equals(queryParamObjectFormat);
  }

  public boolean getQueryParamObjectFormatKey() {
    return CustomAngularGenerator.QUERY_PARAM_OBJECT_FORMAT_TYPE.key.equals(queryParamObjectFormat);
  }
  ...
  public void setQueryParamObjectFormat(String format) {
    try {
      queryParamObjectFormat = CustomAngularGenerator.QUERY_PARAM_OBJECT_FORMAT_TYPE.valueOf(format);
    } catch (IllegalArgumentException e) {
      String values = Stream.of(CustomAngularGenerator.QUERY_PARAM_OBJECT_FORMAT_TYPE.values())
  ...
  public void setProvidedIn (String level) {
    try {
      providedIn = CustomAngularGenerator.PROVIDED_IN_LEVEL.valueOf(level);
    } catch (IllegalArgumentException e) {
      String values = Stream.of(CustomAngularGenerator.PROVIDED_IN_LEVEL.values())
              .map(value -> "'" + value.name() + "'")
              .collect(Collectors.joining(", "));
  ...
  private boolean getIsProvidedInNone() {
    return CustomAngularGenerator.PROVIDED_IN_LEVEL.none.equals(providedIn);
  }
}
