 ...
 * 1) Set a break point in CustomAngularGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class CustomAngularGeneratorTest {
...
//              .setGeneratorName("custom-angular") // use this codegen library
...
//              .setOutputDir("out/custom-angular"); // output directory
//
